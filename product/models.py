...
class TrackDetail(models.Model):
    courier_key         = models.ForeignKey(CourierPartner, on_delete = models.CASCADE)
...
class Order(models.Model):
    ...
    track_key     = models.ForeignKey(TrackDetail, on_delete = models.CASCADE, blank = True, null = True)
    product_key   = models.ForeignKey(ProductDetail, on_delete = models.CASCADE)
